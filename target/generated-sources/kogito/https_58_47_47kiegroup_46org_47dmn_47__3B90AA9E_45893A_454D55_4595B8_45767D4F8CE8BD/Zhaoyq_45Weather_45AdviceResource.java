 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__3B90AA9E_45893A_454D55_4595B8_45767D4F8CE8BD;
...
@Path("/zhaoyq-Weather-Advice")
public class Zhaoyq_45Weather_45AdviceResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_3B90AA9E-893A-4D55-95B8-767D4F8CE8BD", "zhaoyq-Weather-Advice");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_3B90AA9E-893A-4D55-95B8-767D4F8CE8BD", "zhaoyq-Weather-Advice", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("zhaoyq-Weather-Advice") + ".dmn_nologic")));
    }
